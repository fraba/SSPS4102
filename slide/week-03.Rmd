...
.center[<img src ='https://socviz.co/assets/ch-01-channels-for-cont-data-vertical.png' width = "15%"></img>]
...
```{r out.width = '90%', fig.height = 4, fig.width = 9}
...
.center[<img src = 'https://socviz.co/assets/ch-03-ggplot-flow-vertical.png' width = '40%'></img>]]
