...
The value `1` in a cell of the matrix represents a marriage among the first five Florentine families. The value `0` the absence of a marriage linking the two families.
...
* *Degree* is the number of connections of a node, but only measure the immediate neighborhood of a node.
...
* *Betweenness* is the instead a measure for the number *paths* that a traverse a node as you move from between any other pair of nodes. 
