...
creates two new columns `gain` and `speed`. For example, `gain` is the result of the *row-wise* subtraction of the value `arr_delay` from the value `dep_delay` (again, for each record). So,
