...
4. Describe (using visuals and words) the distribution of 
    ...
    4.2 `confidence_govt_index`  –  for  selected  countries  separately.  
    
    Do  they  look  the  same  across countries? 

5. Conclude with a general comment on support for democracy and confidence in institutions in these three countries. 
...
* **R Markdown template (source)** [a1-template.Rmd](a1-template.Rmd)

* **R Markdown template (rendered)** [a1-template.pdf](a1-template.pdf)